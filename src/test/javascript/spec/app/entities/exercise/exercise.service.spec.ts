...
import { IExercise, Exercise, ExerciseType, ExerciseBodyParts } from 'app/shared/model/exercise.model';
...
describe('Service Tests', () => {
  describe('Exercise Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Exercise('ID', 'AAAAAAA', ExerciseType.BARBELL, ExerciseBodyParts.SHOULDERS);
    });
